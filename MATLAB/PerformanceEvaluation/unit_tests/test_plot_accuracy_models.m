...
for n = 1 : num_datasets
     disp(['Creating Accuracy plot for image training data store # ', num2str(n), ' out of ', ...
    ...
    title_str = ['Validation performance for tiles of size ' res_str];
    [fig_h] = plot_accuracy_models( data_table,[0 0 1],title_str);
